...
.e-hscroll .e-scroll-nav:hover:active {
  border: 0;
}
...
.e-hscroll .e-scroll-nav:active .e-icons {
  color: #000;
}
...
.e-toolbar .e-tbar-btn:hover:focus .e-tbar-btn-text, .e-toolbar .e-tbar-btn:hover:active .e-icons,
...
.e-accordion .e-acrdn-item .e-acrdn-panel.e-nested .e-expand-state span.e-icons,
