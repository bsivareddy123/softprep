...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-popups"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3, ej2_base_4, ej2_base_5, ej2_popups_1) {
    ...
    var Slider = /** @class */ (function (_super) {
        ...
        Slider.prototype.initRender = function () {
            this.sliderContainer = ej2_base_4.createElement('div', { className: classNames.sliderContainer });
            this.element.parentNode.insertBefore(this.sliderContainer, this.element);
            this.sliderContainer.appendChild(this.element);
            this.sliderTrack = ej2_base_4.createElement('div', { className: classNames.sliderTrack });
            ...
            this.createRangeBar();
            this.setOrientClass();
            this.hiddenInput = (ej2_base_4.createElement('input', {
                attrs: {
        ...
        Slider.prototype.createRangeBar = function () {
            if (this.type !== 'default') {
                this.rangeBar = (ej2_base_4.createElement('div', { attrs: { class: classNames.rangeBar } }));
        ...
        Slider.prototype.createSecondHandle = function () {
            this.secondHandle = ej2_base_4.createElement('div', {
                attrs: {
            ...
            if (this.isMaterial && this.tooltip.isVisible) {
                this.secondMaterialHandle = ej2_base_4.createElement('div', {
                    attrs: {
        ...
        Slider.prototype.createFirstHandle = function () {
            this.firstHandle = ej2_base_4.createElement('div', {
                attrs: {
                    class: classNames.sliderHandle, 'role': 'slider', 'aria-labelledby': this.element.id + '_title', tabIndex: '0'
                }
            });
            ...
            if (this.isMaterial && this.tooltip.isVisible) {
                this.firstMaterialHandle = ej2_base_4.createElement('div', {
                    attrs: {
                        class: classNames.sliderHandle + ' ' +
                            classNames.sliderMaterialHandle
                    }
        ...
        Slider.prototype.setTooltipContent = function () {
            ...
            if (this.type === 'range') {
                ...
                if (!ej2_base_5.isNullOrUndefined(this.handleVal1)) {
            ...
            if (!ariaContent) {
                if (this.type === 'range') {
                    if (this.enableRtl && this.orientation !== 'vertical') {
                        content = (!ej2_base_5.isNullOrUndefined(formatInfo.format)) ? (this.formatString(this.handleVal2, formatInfo)
                            .formatString + ' - ' + this.formatString(this.handleVal1, formatInfo).formatString) :
                            (this.handleVal2.toString() + ' - ' + this.handleVal1.toString());
                    }
                    else {
                        content = (!ej2_base_5.isNullOrUndefined(formatInfo.format)) ? (this.formatString(this.handleVal1, formatInfo)
        ...
        Slider.prototype.wireMaterialTooltipEvent = function (destroy) {
            if (this.isMaterial && this.tooltip.isVisible) {
                if (!destroy) {
                    ej2_base_1.EventHandler.add(this.firstTooltipElement, 'mousedown touchstart', this.sliderDown, this);
                    if (this.type === 'range') {
                        ej2_base_1.EventHandler.add(this.secondTooltipElement, 'mousedown touchstart', this.sliderDown, this);
                    }
                }
                else {
                    ej2_base_1.EventHandler.remove(this.firstTooltipElement, 'mousedown touchstart', this.sliderDown);
                    if (this.type === 'range') {
                        ej2_base_1.EventHandler.remove(this.secondTooltipElement, 'mousedown touchstart', this.sliderDown);
                    }
                }
            }
        };
        ...
        Slider.prototype.renderTooltip = function () {
            ...
            this.firstTooltipObj = new ej2_popups_1.Tooltip({
            ...
            if (this.type === 'range') {
                this.secondTooltipObj = new ej2_popups_1.Tooltip({
                    showTipPointer: false,
                    cssClass: classNames.sliderTooltip,
                    animation: { open: { effect: 'None' }, close: { effect: 'None' } },
                    opensOn: 'custom',
        ...
        Slider.prototype.setButtons = function () {
            this.firstBtn = ej2_base_4.createElement('div', { className: classNames.sliderButton + ' ' + classNames.firstButton });
            this.firstBtn.appendChild(ej2_base_4.createElement('span', { className: classNames.sliderButtonIcon }));
            this.firstBtn.tabIndex = -1;
            this.secondBtn = ej2_base_4.createElement('div', { className: classNames.sliderButton + ' ' + classNames.secondButton });
            this.secondBtn.appendChild(ej2_base_4.createElement('span', { className: classNames.sliderButtonIcon }));
        ...
        Slider.prototype.renderScale = function () {
            ...
            this.ul = ej2_base_4.createElement('ul', {
            ...
            for (var i = 0; i <= count; i++) {
                li = (ej2_base_4.createElement('li', {
                    attrs: {
        ...
        Slider.prototype.createTick = function (li, start) {
            var span = ej2_base_4.createElement('span', {
        ...
        Slider.prototype.scaleAlignment = function () {
            ...
            if (orien === 'v') {
                ...
                for (var i = 0; i < ticksSpan.length; i++) {
                    if (!ej2_base_5.isNullOrUndefined(this.ticks) && !ej2_base_5.isNullOrUndefined(this.ticks.placement)) {
                        if (this.ticks.placement === 'after') {
                            ej2_base_4.setStyleAttribute(ticksSpan[i], { 'left': this.sliderTrack.clientWidth + largeTick + 'px' });
                        }
                        else {
                            var width = this.sliderTrack.clientWidth + largeTick;
                            ej2_base_4.setStyleAttribute(ticksSpan[i], { 'right': width + 'px' });
                        }
                    }
                }
            }
        ...
        Slider.prototype.changeSliderType = function (type) {
            ...
            if (this.tooltip.isVisible && !ej2_base_5.isNullOrUndefined(this.firstTooltipObj)) {
                this.firstTooltipObj.destroy();
                if (type === 'range' && !ej2_base_5.isNullOrUndefined(this.secondTooltipObj)) {
        ...
        Slider.prototype.destroy = function () {
            ...
            if (this.tooltip.isVisible) {
                this.firstTooltipObj.destroy();
                if (this.type === 'range' && !ej2_base_5.isNullOrUndefined(this.secondTooltipObj)) {
                    this.secondTooltipObj.destroy();
                }
            }
            ...
            for (var _i = 0, _a = Object.keys(newProp); _i < _a.length; _i++) {
                ...
                switch (prop) {
                    case 'cssClass':
                        ...
                        break;
                    case 'value':
                        if (!ej2_base_5.isNullOrUndefined(oldProp.value) && !ej2_base_5.isNullOrUndefined(newProp.value)) {
