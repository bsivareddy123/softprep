...
define(["require", "exports", "@syncfusion/ej2-base", "@syncfusion/ej2-base", "@syncfusion/ej2-base"], function (require, exports, ej2_base_1, ej2_base_2, ej2_base_3) {
    ...
    var Uploader = /** @class */ (function (_super) {
        ...
        Uploader.prototype.renderPreLoadFiles = function () {
            ...
            if (files.length === 0 || !ej2_base_1.isNullOrUndefined(this.template)) {
                return;
            }
            var filesData = [];
            if (!this.multiple) {
        ...
        Uploader.prototype.updateStatus = function (files, status) {
            if (!(status === '' || ej2_base_1.isNullOrUndefined(status))) {
                files.status = status;
            }
        ...
        Uploader.prototype.uploadInProgress = function (e, files, customUI) {
            ...
            if (!ej2_base_1.isNullOrUndefined(li)) {
                if (!(li.querySelectorAll('.' + PROGRESS_WRAPPER).length > 0) && (this.template === '' || ej2_base_1.isNullOrUndefined(this.template))) {
        ...
        __decorate([
            ej2_base_1.Property({ saveUrl: '', removeUrl: '' })
        ...
        __decorate([
            ej2_base_1.Property({ browse: 'Browse', clear: 'Clear', upload: 'Upload' })
        ...
        __decorate([
            ej2_base_1.Property({ name: '', size: null, type: '' })
