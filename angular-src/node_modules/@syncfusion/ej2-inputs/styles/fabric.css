...
.e-slider-container .e-slider .e-tab-track {
...
.e-slider-container.e-horizontal.e-scale-both .e-slider-track {
  border-color: #fff;
  border-radius: 1px;
  border-style: solid;
  border-width: 5px 0;
...
.e-slider-container.e-vertical.e-scale-both .e-range {
  margin-left: -1px;
}
...
.e-slider-container:not(.e-disabled):not(.e-read-only):active .e-handle {
  border-color: #0078d7;
}

.e-slider-container:not(.e-disabled):not(.e-read-only):active .e-range {
  background-color: #006fc8;
}

.e-slider-container:not(.e-disabled):not(.e-read-only):active .e-slider-track {
  background-color: #b8e0ff;
}
