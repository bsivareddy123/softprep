...
.e-widget.e-control-wrapper.e-mask .e-maskedtextbox {
  font-family: Arial, "Segoe UI", "GeezaPro", "DejaVu Serif", "sans-serif";
  font-size: 13px;
}
...
.e-slider-container.e-vertical .e-second-button .e-button-icon {
  background-image: url("data:image/png;base64,");
  background-repeat: no-repeat;
  background-size: cover;
  display: inline-block;
  height: 8px;
...
.e-slider-container .e-tick-before.e-scale.e-h-scale.e-tick-pos .e-tick {
  height: 4px;
  top: 0;
}

.e-slider-container .e-tick-before.e-scale.e-h-scale.e-tick-pos .e-large {
  height: 7px;
  top: 0;
}

.e-slider-container .e-tick-after.e-scale.e-h-scale.e-tick-pos .e-tick {
  height: 4px;
  top: 18px;
}

.e-slider-container .e-tick-after.e-scale.e-h-scale.e-tick-pos .e-large {
  height: 7px;
  top: 21px;
}
...
.e-slider-container .e-scale.e-tick-both {
  top: 12px;
}
...
.e-slider-container.e-vertical.e-scale-both .e-scale {
  right: 11px;
}

.e-slider-container.e-vertical.e-scale-both .e-slider-track {
  left: calc(50% - 4px);
  width: 8px;
}
...
.e-slider-container.e-scale-both.e-vertical .e-scale.e-h-scale {
  margin-left: -7px;
}

.e-slider-container.e-scale-both.e-vertical.e-small-size .e-scale.e-h-scale {
  margin-left: -7px;
}
...
.e-slider-container .e-scale.e-v-scale .e-tick .e-tick-value.e-tick-both:last-child {
  margin-right: 22px;
}
...
.e-slider-container .e-slider .e-range.e-tab-range {
  background-color: #166600;
}
