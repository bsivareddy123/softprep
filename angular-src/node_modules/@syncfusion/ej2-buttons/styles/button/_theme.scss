  ...
  .e-css.e-btn {
    ...
    @at-root {
      ...
      &:active {
        ...
        outline-offset: $active-outline-offset;
      }
      ...
      &.e-active {
        ...
        &:hover {
          background-color: $btn-toggle-hover-bgcolor;
          border-color: $btn-toggle-hover-bgcolor;
          color: $btn-active-color;
       }
      }
      ...
      &.e-outline {
        ...
        &:focus {
          ...
          border-color: $btn-outline-focus-border-color;
          box-shadow: $btn-box-shadow;
