@include export-module('dialog-layout') {
  ...
  .e-dialog {
    ...
    .e-btn .e-btn-icon.e-icon-dlg-close {
      ...
      height: $dialog-close-icon-height;
      margin-left: $dialog-close-icon-margin-left;
  ...
  &.e-bigger .e-dialog {
    ...
    & .e-btn .e-btn-icon.e-icon-dlg-close {
      ...
      height: $dialog-bigger-close-icon-height;
      margin-left: $dialog-bigger-close-icon-margin-left;
    ...
    & .e-btn.e-dlg-closeicon-btn {
      ...
      padding: $dialog-bigger-close-icon-button-padding;
  ...
  .e-bigger .e-rtl .e-btn .e-btn-icon.e-icon-dlg-close {
    margin-right: $dialog-bigger-close-icon-margin-right;
  }
  ...
  .e-rtl .e-dlg-header-content .e-btn.e-dlg-closeicon-btn {
    float: left;
    right: $dialog-close-button-right;
  }
  ...
  .e-dlg-header-content .e-btn.e-dlg-closeicon-btn {
    ...
    padding: $dialog-close-icon-button-padding;
    position: relative;
