@include export-module('tooltip-theme') {
  ...
  #{&}.e-tooltip-wrap {
    ...
    .e-arrow-tip-inner {
      ...
      &.e-tip-bottom {
        border-left: $tooltip-arrow-inner-border $border-type transparent;
        border-right: $tooltip-arrow-inner-border $border-type transparent;
        border-top: $tooltip-arrow-inner-border $border-type $tooltip-content-bg-color;
        left: 1px;
        top: 0;
      }

      &.e-tip-top {
        border-bottom: $tooltip-arrow-inner-border $border-type $tooltip-content-bg-color;
        border-left: $tooltip-arrow-inner-border $border-type transparent;
        border-right: $tooltip-arrow-inner-border $border-type transparent;
        left: 1px;
        top: 1px;
      ...
      &.e-tip-left {
        border-bottom: $tooltip-arrow-inner-border $border-type transparent;
        border-right: $tooltip-arrow-inner-border $border-type $tooltip-content-bg-color;
        border-top: $tooltip-arrow-inner-border $border-type transparent;
        left: 1px;
        top: 1px;
      }
      ...
      &.e-tip-right {
        border-bottom: $tooltip-arrow-inner-border $border-type transparent;
        border-left: $tooltip-arrow-inner-border $border-type $tooltip-content-bg-color;
        border-top: $tooltip-arrow-inner-border $border-type transparent;
        left: 0;
        top: 1px;
      }
