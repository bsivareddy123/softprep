...
export var inputs = ['allowDragAndDrop', 'allowEditing', 'allowMultiSelection', 'animation', 'checkedNodes', 'cssClass', 'enablePersistence', 'enableRtl', 'expandOn', 'fields', 'fullRowSelect', 'locale', 'nodeTemplate', 'selectedNodes', 'showCheckBox', 'sortOrder'];
export var outputs = ['created', 'dataBound', 'destroyed', 'drawNode', 'keyPress', 'nodeChecked', 'nodeChecking', 'nodeClicked', 'nodeCollapsed', 'nodeCollapsing', 'nodeDragStart', 'nodeDragStop', 'nodeDragging', 'nodeDropped', 'nodeEdited', 'nodeEditing', 'nodeExpanded', 'nodeExpanding', 'nodeSelected', 'nodeSelecting'];
export var twoWays = [''];
/**
...
var TreeViewComponent = /** @class */ (function (_super) {
    ...
    function TreeViewComponent(ngEle, viewContainerRef) {
...
applyMixins(TreeViewComponent, [ComponentBase]);
