define(["require", "exports", "./intl-base", "./parser-base", "../util", "./date-formatter"], function (require, exports, intl_base_1, parser_base_1, util_1, date_formatter_1) {
    "use strict";
        ...
        DateParser.dateParser = function (culture, option, cldr) {
            ...
            if (util_1.isUndefined(resPattern)) {
                ...
                for (var i = 0; i < length_1; i++) {
                    ...
                    var charKey = date_formatter_1.datePartMatcher[char];
                    var optional = (len === 2) ? '' : '?';
                    if (isgmtTraversed) {
